    ...
    <footer className="footer">
      ...
      <div className="transition-all">
        ...
        <div className="grid grid-flow-col gap-4">
          <a target="_blank" href={Owner.WebsiteDetails.twitterLink}>
            <svg
          ...
          <a target="_blank" href={Owner.WebsiteDetails.youtubeLink}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a target="_blank" href={Owner.WebsiteDetails.facebookLink}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
