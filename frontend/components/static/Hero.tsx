  ...
  return (
    <>
      ...
      <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 ">
        <span className="absolute -left-6 md:left-4 top-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12 rounded-3xl bg-primary blur-xl opacity-60 lg:opacity-95 lg:block hidden"></span>
      ...
      <div className="container relative flex flex-row items-center flex-wrap">
        ...
        <div className="flex flex-1 order-1 -top-20 md:top-0 md:order-2 py-0 px-5 md:p-5 w-full lg:w-1/2 h-1/2 my-0 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
          ...
          width={2350}
          height={2359}
          className="md:absolute md:w-full md:h-full rounded-3xl object-cover md:max-h-none max-h-96"
            /> */}
          <svg
