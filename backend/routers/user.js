...
router.get('/get-all-orders',authintications,authintication,getAllOrdersByDay)
router.post('/edit-credit/:userId',authintications,authintication,editCredit)
router.put('/update-user/:userId',authintications,updateUserValidator,updateUser)
