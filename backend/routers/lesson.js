...
const { blockingExam } = require('../middlewares/blockingExam')

const router = express.Router()

router.post('/:sectionId/add-lesson',authintications,authintication,addLessonValidator,addLesson)
router.get('/get-lesson/:lessonId',authintications,getLessonValidator,blockingExam,enrolledCourse,getLesson)
